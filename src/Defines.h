...
String CURRENT_VERSION_SW = "1.60";     // Текущая версиия прошивки 
String VERSION_SW = "Версия ПО 1.60";   // Текст для отображения
...
int pwmChannel[] = {pwmChannel_1, pwmChannel_2, pwmChannel_3, pwmChannel_4};
